---
layout: chapter
title: Sejarah Singkat Huruf Cetak #A Brief History of Type
finished: true
---
...
Dahulu kala, *font* merupakan sekumpulan potongan logam. Penggunaan huruf cetak berbentuk logam pertama kali dicatat dalam sejarah terjadi di China. Pada abad ke-13, uang kertas dicetak menggunakan alat anti-pemalsuan yang terbuat dari potongan-potongan tembaga; [^2] pada waktu yang hampir bersamaan, Buku-buku dicetak menggunakan blok huruf pertama kali di Korea. [^1] Dua ratus tahun kemudian, Johannes Gutenberg datang membawa sistem serupa untuk membuat huruf cetak yang kemudian menyebar dengan cepat ke seluruh Eropa dan menjadi metode yang paling umum digunakan dalam kegiatan percetakan sampai abad ke-19.
...
Dalam membuat blok huruf untuk percetakan, seorang *engraver* akan memahat bentuk huruf, angka, dan lainnya ke ujung sebuah pahat. Pahat tersebut dihantamkan pada sebuah cetakan bernama *matrix*. Pembuat huruf kemudian menggunakan cetakan tersebut sebagai dasar untuk mengecor berbagai macam bentuk huruf (disebut juga sebagai *sorts*). Satu set lengkap dari dari berbagai macam huruf dengan ukuran dan gaya yang sama kemudian dikumpulkan menjadi sebuah *font*.
...
> Sebuah kotak berisi cetakan fon oleh *Australian Typo Foundry*. Fon pada kiri atas merupakan ukuran 14pt dari Greek Typefaces oleh Eric Gill
...
Kumpulan fon dan huruf ditempatkan dalam sebuah tempat (*type cases*), penyusun huruf kemudian memilih huruf-huruf yang dibutuhkan untuk mencetak sebuah halaman dan disusun menjadi baris-baris kata. Selanjutnya, pencetak akan melumuri bagian huruf yang sudah disusun dengan tinta dan mencetaknya pada sebuah kertas. Dengan hadirnya teknologi penyusunan huruf menggunakan metal panas, yang menggabungkan antara proses pengecoran dan komposisi menjadi satu proses otomatis, fon-fon balok menjadi tidak relevan.
...
Gagasan tentang fon balok kembali muncul dengan munculnya tipografi digital. Pada tahun 1964, IBM 2260 *Display Station* salah satu yang pertama kali menghadirkan antarmuka visual berbasis teks ke dalam sebuah komputer.[^3] Komputer mainframe akan menghasilkan sinyal video dan mengirimkannya ke layar, piksel demi piksel: setiap karakter memiliki lebar 9 piksel dan tinggi 14 piksel. Potongan-potongan gambar *(bitmap)* dari setiap karakter, yang sekarang kita sebut dangan fon, sudah terprogram didalam inti komputer dan tidak dapat dirubah.
...
Banyak perkembangan yang terjadi sejak pertama kali kita mengenal fon *bitmap*, namun ada satu hal yang tetap sama. Perpindahan dari cetakan metal berbentuk balok milik Gutenberg hingga persegi gambar digital berukuran 9x14 piksel memastikan bahwa tipografi digital akan didominasi oleh susunan-susunan persegi yang ditata sepanjang garis dasar yang sama - situasi yang kurang menguntungkan untuk sistem tulis yang tidak bertumpu pada garis-garis lurus dan persegi.

<!-- ![Nastaleeq calligraphy by حححححححح (Wikipedia)](history/640px-Ghafeleye_Omr.svg.png) -->
![Kaligrafi Nastaleeq by حححححححح (Wikipedia)](history/640px-Ghafeleye_Omr.svg.png)
...
Salah satu alasan saya memulai buku ini dengan sejarah perkembangan fon: bagaimana fon berkembang dari waktu ke waktu juga turut membentuk halangan dan tantangan yang kita hadapi sekarang ini. Pada saat yang bersamaan, sejarah perkembangan fon digital juga akan menyoroti berbagai halangan yang harus dihadapi oleh para desainer dan para pembuat teknologi, dan mengenalkan beberapa konsep yang akan banyak ditemui sepanjang buku ini. Jangan lewatkan bagian ini, meskipun kalian bukan penggemar sejarah. - akan aku jelaskan semudah mungkin.
